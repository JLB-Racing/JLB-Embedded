...
{
	uint8_t i,j;
	distance_sensor.voltage_long[0] = ((float)(adc_values_raw.distance_long1_raw)) / 4096.0f * 3.3f;
	distance_sensor.voltage_long[1] = ((float)(adc_values_raw.distance_long2_raw)) / 4096.0f * 3.3f;
	distance_sensor.voltage_short[0] = ((float)(adc_values_raw.distance_short1_raw)) / 4096.0f * 3.3f;
	distance_sensor.voltage_short[1] = ((float)(adc_values_raw.distance_short2_raw)) / 4096.0f * 3.3f;
