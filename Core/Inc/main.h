...
#define INFRA_LE_F_Pin GPIO_PIN_0
#define INFRA_LE_F_GPIO_Port GPIOD
#define LED_LE_F_Pin GPIO_PIN_1
#define LED_LE_F_GPIO_Port GPIOD
#define INFRA_OE_F_Pin GPIO_PIN_2
...
#define LED_OE_F_Pin GPIO_PIN_7
#define LED_OE_F_GPIO_Port GPIOD
#define INFRA_LE_R_Pin GPIO_PIN_9
#define INFRA_LE_R_GPIO_Port GPIOG
#define LED_LE_R_Pin GPIO_PIN_10
#define LED_LE_R_GPIO_Port GPIOG
#define INFRA_OE_R_Pin GPIO_PIN_12
#define INFRA_OE_R_GPIO_Port GPIOG
#define LED_OE_R_Pin GPIO_PIN_13
