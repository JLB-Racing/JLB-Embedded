...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB1     ------> ADC1_IN16
    */
    HAL_GPIO_DeInit(GPIOC, BATT_VOLTAGE_Pin|MOT_CURR_Pin|VBUS_SENSE_Pin|ENC_CHA_Pin);

    HAL_GPIO_DeInit(GPIOA, DISTANCE2_ADC_Pin|DISTANCE1_ADC_Pin|DISTANCE3_ADC_Pin|LV_BATT_Pin);

    HAL_GPIO_DeInit(GPIOB, ENC_CHBB0_Pin|DISTANCE4_ADC_Pin);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI1_MspDeInit 0 */
    ...
    PE15     ------> SPI1_MOSI
    */
    HAL_GPIO_DeInit(GPIOA, SPI_ADC_CLK_Pin|SPI_ADC_MISO_Pin);

    HAL_GPIO_DeInit(SPI_ADC_MOSI_GPIO_Port, SPI_ADC_MOSI_Pin);
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* htim_base)
{
  ...
  /* USER CODE END TIM1_MspDeInit 0 */
    ...
    PA10     ------> TIM1_CH3
    */
    HAL_GPIO_DeInit(RC_PWM_STEERING_IN_GPIO_Port, RC_PWM_STEERING_IN_Pin);

    HAL_GPIO_DeInit(GPIOA, RC_PWM_STEERING_Pin|RC_PWM_THROTTLE_IN_Pin);
...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* htim_encoder)
{
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PE4     ------> TIM3_CH2
    */
    HAL_GPIO_DeInit(GPIOE, ENC_CH_A_Pin|ENC_CHB_Pin);
